...
function initPositioningTransform() {
	...
	positioning.multiply(tmp.makeTranslation(-125, -300, 75));
}
...
var dataSources = [
	{type: 'json', args: ['data/UnitedStates-topo.json'], key: 'judete'},
	{type: 'json', args: ['data/us-id.json'], key: 'id_judete'},
	{type: 'csv', args: ['data/data.csv'], key: 'recensaminte'}
];
...
loadData(dataSources, function(results) {
	...
	var features = topojson.feature(judete, judete.objects['collection']).features;
